...
for i = 1:1:(num_drone-1)
    ...
    model_config(i) = model_config(i).setBlockParameter(sub_camera, "Topic", "/drone/"+i+"/onboard_camera/image_raw");
    model_config(i) = model_config(i).setBlockParameter(sub_odometry, "Topic", "/drone/"+i+"/odometry");
end
