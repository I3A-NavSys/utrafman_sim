// This file is part of SIAM simulator and implements the drone control
...
//Custom messages from siam simulator
...
//------------------------------------------------------------------------------------------------------
    ...
    public:
        ...
        void OnUpdate(const common::UpdateInfo &evento /*_info*/)
        {
            ...
            double ttrw;                            //Time to reach the next waypoint
            ...
            if (uplan_inprogress && (current_time.Double() >= uplan_local->dtto)){
                ...
                //Compute target velocity at the current time given the U-plan
